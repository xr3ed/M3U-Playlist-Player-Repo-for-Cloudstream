...
subprojects {
    ...
    android {
        ...
        defaultConfig {
            ...
            buildConfigField("String", "BYSE_API_VERIFY", "\"${getSecret("BYSE_API_VERIFY", "dummy")}\"")
            buildConfigField("String", "BYSE_API_SETTINGS", "\"${getSecret("BYSE_API_SETTINGS", "dummy")}\"")
            buildConfigField("String", "ABYSS_KEY_FORMAT", "\"${getSecret("ABYSS_KEY_FORMAT", "dummy")}\"")
            buildConfigField("String", "ABYSS_PATH_FORMAT", "\"${getSecret("ABYSS_PATH_FORMAT", "dummy")}\"")
            buildConfigField("String", "ABYSS_FINAL_FORMAT", "\"${getSecret("ABYSS_FINAL_FORMAT", "dummy")}\"")
            buildConfigField("String", "LIBRARY_PACKAGE_NAME", "\"com.xr3ed\"")
            val rawDracinUrl = getSecret("DRACINAIO_URL", "dummy")
            val base64DracinUrl = if (rawDracinUrl == "dummy") "dummy" else java.util.Base64.getEncoder().encodeToString(rawDracinUrl.toByteArray())
            buildConfigField("String", "DRACINAIO_URL", "\"$base64DracinUrl\"")
