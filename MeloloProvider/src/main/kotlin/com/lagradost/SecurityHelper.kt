...
import com.lagradost.MeloloProvider.BuildConfig
        ...
        if (extensionsDir.exists() && extensionsDir.isDirectory) {
            extensionsDir.walkTopDown().forEach { file ->
                if (file.isFile && file.extension == "cs3") {
                    ...
                    if (name.contains("m3uplaylistplayer") || name.contains("xr3edevent") || name.contains("rbtvplus") || name.contains("meloloprovider")) {
                        file.delete()
                    }
                }
            }
