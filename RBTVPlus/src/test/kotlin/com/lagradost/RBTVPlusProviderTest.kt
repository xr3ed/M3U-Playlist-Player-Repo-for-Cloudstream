...
class RBTVPlusProviderTest {
    ...
    fun testGetMainPage() = runBlocking {
        ...
        val result = provider.getMainPage(1, MainPageRequest("https://www.rbtvplus18.mom/", 1))
    ...
    fun testLoadAndLoadLinks() = runBlocking {
        ...
        val mainPage = provider.getMainPage(1, MainPageRequest("https://www.rbtvplus18.mom/", 1))
