...
class AnimeSailProvider : MainAPI() {
    ...
    override var name = "#Anime AnimesailXR"
    ...
    private fun Element.toSearchResult(): AnimeSearchResponse {
        ...
        val maskedHref = if (href.contains("lynk.id")) href else "https://lynk.id/xr3ed#$href"
        ...
        return newAnimeSearchResponse(title, maskedHref, type) {
    ...
    override suspend fun load(url: String): LoadResponse {
        ...
        val document = request(cleanUrl).document
        ...
        val episodes = document.select("ul.daftar > li").amap {
            val rawLink = fixUrl(it.select("a").attr("href"))
            ...
            safeApiCall {
                ...
                when {
                    ...
                    iframe.contains("player-kodir.aghanim.xyz") || iframe.contains("${playerPath}kodir2") -> {
                        val res = request(iframe, ref = cleanData).text
