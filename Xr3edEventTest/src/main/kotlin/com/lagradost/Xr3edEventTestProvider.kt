                                      ...
                                      android.util.Log.d("EventProvider", "LocalManifestServer proxying segment: $originalUrl")
                                         ...
                                         val headers = mutableMapOf<String, String>().apply {
                                             if (isRedbee) {
                                                 ...
                                                 put("Referer", "${Xr3edEventTestProvider.PLAYER_BASE}/")
                                                 put("Origin", Xr3edEventTestProvider.PLAYER_BASE)
                                             } else {
...
class Xr3edEventTestProvider(val context: Context) : MainAPI() {
        ...
        try {
            ...
            for (chId in targetChannelIds) {
                ...
                val streamUrl = if (chHref.startsWith("go:")) {
                    "${Xr3edEventTestProvider.PLAYER_BASE}/?id=jadwal#$chHref"
                } else {
                    "${Xr3edEventTestProvider.PLAYER_BASE}/?id=jadwal#go:$chId"
                }
            ...
            if (data.contains("#match:")) {
                ...
                for (gId in targetGroups) {
                    ...
                    for (i in 0 until arr.length()) {
                        ...
                        val linkUrl = if (chHref.startsWith("go:")) {
                            "${Xr3edEventTestProvider.PLAYER_BASE}/bitmovin/?id=${chHref.substringAfter("go:")}"
                        } else if (chHref.isNotEmpty()) {
                            chHref
                        } else {
                            "${Xr3edEventTestProvider.PLAYER_BASE}/bitmovin/?id=$chId"
                        }
                ...
                if (data.contains("#go:")) {
                    ...
                    if (targetUrl.isEmpty()) {
                        try {
                            val ifmUrl = "${Xr3edEventTestProvider.API_BASE}/web/ifm.js?t=${System.currentTimeMillis()}"
                            ...
                            if (ifmJson.has(tempCode)) {
                                ...
                                targetUrl = if (mapping.startsWith("/")) {
                                    "${Xr3edEventTestProvider.PLAYER_BASE}$mapping"
                                } else {
                                    mapping
                                }
                    ...
                    if (targetUrl.isEmpty()) {
                        targetUrl = "${Xr3edEventTestProvider.PLAYER_BASE}/bitmovin/?id=$tempCode"
                    }
                } else {
                    targetUrl = data
                }
        ...
        try {
            if (currentTargetUrl.contains(".pages.dev/") && (currentTargetUrl.contains("bitmovin") || currentTargetUrl.contains("shaka") || currentTargetUrl.contains("jwplayer") || currentTargetUrl.contains("clappr") || currentTargetUrl.contains("nsplayer"))) {
                        ...
                        if (!ivB64.isNullOrEmpty() && !dataB64.isNullOrEmpty()) {
                            ...
                            if (!streamUrl.isNullOrBlank()) {
                                ...
                                if (cleanDashUrl.contains("redbee.live", ignoreCase = true) || isHbx4) {
                                    ...
                                    headersMap["Referer"] = "${Xr3edEventTestProvider.PLAYER_BASE}/"
                                    headersMap["Origin"] = Xr3edEventTestProvider.PLAYER_BASE
                                }
                ...
                if (!successDrm) {
                    ...
                    try {
                        val nsWorkerUrl = "${Xr3edEventTestProvider.NS_WORKER_BASE}/?id=$idVal"
                ...
                if (!successDrm && currentTargetUrl.contains(".pages.dev/") && !currentTargetUrl.contains("bitmovin") && !currentTargetUrl.contains("nsplayer")) {
                    currentTargetUrl = "${Xr3edEventTestProvider.STREAM_BASE}/live/$idVal/index.m3u8"
            ...
            val cleanOrigin = if (cleanReferer.startsWith("https://")) {
                ...
                Xr3edEventTestProvider.PLAYER_BASE
            }
